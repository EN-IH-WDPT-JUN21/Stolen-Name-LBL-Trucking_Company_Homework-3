...
public class PopulateDatabase implements CommandLineRunner {
    ...
    @Bean
    CommandLineRunner commandLineRunner2 (SalesRepRepository salesRepRepository, AccountRepository accountRepository, LeadRepository leadRepository, OpportunityRepository opportunityRepository, ContactRepository contactRepository) {
        return args -> {

            java.util.List<Lead> leads = leadRepository.saveAll(java.util.List.of(
            ...
            java.util.List<SalesRep> salesReps = salesRepRepository.saveAll(java.util.List.of(
                    new SalesRep("David Lynch"),
                    new SalesRep("Martha Stewart")
            ));

            java.util.List<Contact> contacts = contactRepository.saveAll(java.util.List.of(
            ...
            java.util.List<Opportunity> opportunities = opportunityRepository.saveAll(java.util.List.of(
            ...
            java.util.List<Account> accounts = accountRepository.saveAll(List.of(
