    ...
    public void CityReportMenu_ReportOppByCity() throws NoSuchValueException, AWTException {
        ...
        try {
            ...
            expectedOutput = colorMain + "\n╔════ " + colorMainBold + "Report" + colorMain + " ════════════════════════════╦══════════════════════╗" +
                    reset + "\n" + colorMain + "║ " + colorHeadlineBold + "Name                                   " + colorMain + "║ " + colorHeadlineBold + "Opportunity count    " + colorMain + "║" +
                    "\n" + colorMain + "╠════════════════════════════════════════╬══════════════════════╣" +
                    reset + "\n" + colorMain + "║ " + colorTable + "London                                 " + colorMain + "║ " + colorTable + "1                    " + colorMain + "║" +
                    reset + "\n" + colorMain + "║ " + colorTable + "Madrid                                 " + colorMain + "║ " + colorTable + "1                    " + colorMain + "║" +
                    reset + "\n" + colorMain + "║ " + colorTable + "Paris                                  " + colorMain + "║ " + colorTable + "1                    " + colorMain + "║";
